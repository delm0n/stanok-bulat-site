        ...
        for (const key in raw) {
            ...
            if (validatePropName(normalizedKey)) {
                ...
                const prop = (normalized[normalizedKey] =
                    shared_esm_bundler_isArray(opt) || isFunction(opt) ? { type: opt } : Object.assign({}, opt));
                if (prop) {
...
;// CONCATENATED MODULE: ./vue/store.js
...
;// CONCATENATED MODULE: ./vue/mixins/transitionHeight.js
/* harmony default export */ const transitionHeight = ({
  methods: {
...
;// CONCATENATED MODULE: ./vue/components/Promocode.js
...
/* harmony default export */ const components_Promocode = (Promocode);

;// CONCATENATED MODULE: ./vue/components/OrderModal.js
...
let OrderModal = {
  ...
  components: {
    Promocode: components_Promocode,
  },
};
/* harmony default export */ const components_OrderModal = (OrderModal);

;// CONCATENATED MODULE: ./vue/components/OrderModel.js
...
/* harmony default export */ const components_OrderModel = (OrderModel);

;// CONCATENATED MODULE: ./vue/components/CalcDelivery.js
...
/* harmony default export */ const components_CalcDelivery = (CalcDelivery);

;// CONCATENATED MODULE: ./vue/components/Tinkoff.js
...
/* harmony default export */ const components_Tinkoff = (Tinkoff);

;// CONCATENATED MODULE: ./vue/vue.js
...
createApp(components_OrderModal).use(store).mount("#order-modal");
createApp(components_OrderModel).use(store).mount("#order-model");
createApp(components_CalcDelivery).use(store).mount("#calc-delivery");
createApp(components_Tinkoff).use(store).mount("#tinkoff-block");
